...
- [x] `Manual`: release version and build number are set correctly. `MARKETING_VERSION = 1.2.1` and `CURRENT_PROJECT_VERSION = 8` on the `Planner` app target for both Debug and Release configurations.
